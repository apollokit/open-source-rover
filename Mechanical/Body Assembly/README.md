...
#### 8.1.3 Attach the PVC clamping hub
...
#### 8.2.1 Mount the pillow bearing blocks
...
#### 8.4.1 Attach the Dual Side Mounts
...
#### 8.4.2 Attach dual side mounts (2)
...
#### 8.4.4 Attach the switch and volt meter
...
#### 8.4.5 Attach the Battery Holder
...
#### 8.4.6 Install the battery holders
...
#### 8.4.7 Build bottom plate assembly
